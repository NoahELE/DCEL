...
#define VICTORIAYMAX (-32.0)
    ...
    switch (stage) {
        case STAGE_0:
            ...
            setupGTKPoints(pointCount, (void *) watchTowers,
            ...
            setupGTKPolyPoints(dcelVerticesCount, (void *) dcel,
            ...
            setupGTKPolyLines(dcelEdgeCount, (void *) dcel,
                              (int (*)(void *, int)) & getDCELEdgeVertexStart,
                              (int (*)(void *, int)) &
                                  getDCELEdgeVertexPairStart,
        ...
        case STAGE_2:
            ...
            while ((currentBisector = readNextBisector(ppFile)) != NULL) {
                struct intersection *intersection = getIntersection(
                    currentBisector, dcel, DEFAULT_FACE, DEFAULTMINLENGTH);
    ...
    switch (stage) {
        ...
        case STAGE_3:
            outputResultDiameter(outputfile, watchTowers, watchTowerCount,
                                 dcel);
            freeWatchTowers(watchTowers, watchTowerCount);
            freeDCEL(dcel);
            break;
        ...
        case STAGE_4:
            outputResultDiameterSorted(outputfile, watchTowers, watchTowerCount,
                                       dcel);
            freeWatchTowers(watchTowers, watchTowerCount);
            freeDCEL(dcel);
            break;
        ...
        default:
            // UNSET & STAGE_ERROR
            fprintf(stderr,
                    "Unexpected unhandled stage at output/free step (%s).\n",
                    getStageString(stage));
    }
